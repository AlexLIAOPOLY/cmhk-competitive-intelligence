(() => {
  ...
  function globalSchedulerLineageModel(runs, stages) {
    ...
    return {
      ...
      groups: [{ key: "databases", label: "四库UI发布", position: [1040, 393], size: [380, 294] }],
    };
  }
