(() => {
  ...
  function legacySchedulerLineageModel(runs, stages, attemptRuns = runs) {
    ...
    const nodePurposes = {
      strategic: "每天03:00和14:00只负责触发后续新闻任务；本节点不搜索、不审核、不保存新闻",
      ...
      "previous-news": "合并前一日03:00和14:00两个权威新闻批次，按URL或标题去重后给01:00补缺搜索作参考",
  ...
  function newsLineageFirstScreenModel(nodeKey, node, relatedRuns, records, events, incoming, outgoing) {
    ...
    const descriptions = {
      ...
      "previous-news": {
        input: "前一日最后两个已完成的权威新闻批次，通常对应03:00和14:00",
