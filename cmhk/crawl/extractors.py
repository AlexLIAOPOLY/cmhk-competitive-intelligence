...
FIELD_PATTERNS: Dict[int, Dict[str, List[str]]] = {
    ...
    47: {
        "收入": ["revenue", "total revenue", "收入"],
        "EBITDA": ["EBITDA"],
        "净利润": ["net profit", "profit attributable", "净利润", "股东应占"],
        "用户数": ["customers", "subscribers", "customer base", "用户"],
        "ARPU": ["ARPU", "average revenue per user"],
        "资本开支": ["capital expenditure", "capital expenditures", "CAPEX"],
        "派息": ["dividend", "distribution per share", "派息"],
    },
    48: {
        "收入": ["revenue", "service revenues", "net revenue"],
        "EBITDA或经营利润": ["EBITDA", "operating income", "operating profit"],
        "净利润": ["net income", "net profit"],
        "用户数": ["subscribers", "customers", "customer additions"],
        "ARPU": ["ARPU", "average revenue per account", "average revenue per user"],
        "资本开支": ["capital expenditures", "capital expenditure", "capex"],
        "自由现金流": ["free cash flow"],
    },
    49: {
        "收入": ["operating revenue", "revenue", "营业收入", "经营收入"],
        "通信服务收入": ["telecommunications services revenue", "service revenue", "通信服务收入"],
        "EBITDA": ["EBITDA"],
        "净利润": ["profit attributable", "net profit", "净利润"],
        "移动及5G用户": ["mobile customers", "5G package customers", "移动客户", "5G套餐客户"],
        "有线宽带用户": ["wireline broadband", "fixed-line broadband", "有线宽带"],
        "ARPU": ["ARPU", "average revenue per user"],
        "资本开支": ["capital expenditure", "capital expenditures", "资本开支"],
        "云收入": ["cloud revenue", "industry digitalisation", "云收入", "产业数字化"],
    },
    50: {
        "云收入": ["cloud revenue", "cloud revenues", "AWS sales", "Intelligent Cloud", "Google Cloud revenues", "Cloud Intelligence Group"],
        "同比增速": ["year-over-year", "year over year", "year-on-year", "growth"],
        "经营利润或利润率": ["operating income", "operating profit", "operating margin", "adjusted EBITA", "gross margin"],
        "积压订单或RPO": ["remaining performance obligation", "RPO", "backlog"],
        "资本开支": ["capital expenditures", "capital expenditure", "capex"],
    },
    52: {
