...
class FrontendCitationRenderingTests(unittest.TestCase):
    ...
    def test_chat_composer_keeps_model_voice_and_send_inside_one_card(self) -> None:
        ...
        self.assertIn("width: min(320px, calc(100vw - 32px))", styles)
        self.assertIn("border-radius: 18px", styles)
        self.assertIn(".chat-model-option { width: 100%; min-height: 46px;", styles)
        self.assertIn(".chat-model-option strong { flex: 1; min-width: 0; overflow: hidden; font-size: 14px;", styles)
