...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=269"', html)
        ...
        self.assertIn('src="/static/app.js?v=276"', html)
        ...
        self.assertIn('href="/static/leadership-board.css?v=16"', html)
...
class IntelligenceEntityScrollTests(unittest.TestCase):
    def test_financial_results_are_visible_on_card_drawer_and_run_log(self) -> None:
        ...
        leadership_styles = (Path(__file__).parent / "web/static/leadership-board.css").read_text(encoding="utf-8")
        ...
        self.assertIn('comparisonChart(selectedMetric', app)
        ...
        self.assertIn('class="intelligence-financial-more"', app)
        self.assertIn('class="intelligence-financial-more-popover"', app)
        self.assertIn('EBITDA · 资本开支 · 派息 · 5G用户', app)
        ...
        self.assertIn(".intelligence-financial-more-popover {", styles)
        self.assertIn(".intelligence-financial-more > summary i {", styles)
        self.assertIn("width: min(100%, 760px);", leadership_styles)
        self.assertIn("min-width: max-content;", leadership_styles)
