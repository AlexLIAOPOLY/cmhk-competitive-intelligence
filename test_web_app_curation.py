...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('href="/static/leadership-board.css?v=1"', html)
        ...
        self.assertIn('Balanced open-grid leadership board', leadership_styles)
        ...
        self.assertIn('多源综合研判', app)
        self.assertIn('event.target.closest(".intelligence-entity-focus > a")', app)
