...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=258"', html)
        ...
        self.assertIn('drop-shadow(.55px 0 0 rgba(78, 176, 194, .82))', styles)
        self.assertIn('drop-shadow(-.4px 0 0 rgba(78, 176, 194, .82))', styles)
        ...
        self.assertIn('href="/static/leadership-board.css?v=11"', html)
        ...
        self.assertIn('focus.ai_summary?.headline || focus.metric?.label', app)
