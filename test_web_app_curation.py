...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=268"', html)
        ...
        self.assertIn('src="/static/app.js?v=275"', html)
        ...
        self.assertIn('width: min(100%, 500px);', leadership_styles)
        ...
        self.assertIn('href="/static/leadership-board.css?v=15"', html)
...
class IntelligenceEntityScrollTests(unittest.TestCase):
    def test_financial_results_are_visible_on_card_drawer_and_run_log(self) -> None:
        ...
        self.assertIn('class="intelligence-financial-table"', app)
        self.assertIn('class="intelligence-financial-chevron"', app)
        self.assertIn('!selectedFocusByDomain.has(domain.id)', app)
        self.assertIn('focuses[nextIndex]?.id === "financials"', app)
        self.assertIn('["revenue", "收入"]', app)
        self.assertIn('["ebitda", "EBITDA"]', app)
        self.assertIn('["net_profit", "净利润"]', app)
        self.assertIn('["capital_expenditure", "资本开支"]', app)
        self.assertIn('["dividend", "派息"]', app)
        self.assertIn('financials: (data.domains || []).map', app)
        self.assertIn('isFinancialFocus ? "数据口径"', app)
        self.assertIn('isFinancialFocus\n        ? focus.insight', app)
        ...
        self.assertIn(".intelligence-financial-table-row {", styles)
        self.assertIn(".intelligence-financial-chevron {", styles)
