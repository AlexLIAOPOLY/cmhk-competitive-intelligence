...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=271"', html)
        ...
        self.assertIn('src="/static/app.js?v=278"', html)
...
class IntelligenceEntityScrollTests(unittest.TestCase):
    def test_financial_results_are_visible_on_card_drawer_and_run_log(self) -> None:
        ...
        self.assertIn('["revenue", "收入对比", "HK$m", "columns"]', app)
        self.assertIn('["net_profit", "净利润对比", "HK$m", "ranking"]', app)
        self.assertIn('["ebitda", "EBITDA", "HK$m", "lollipop"]', app)
        self.assertIn('["capital_expenditure", "资本开支", "HK$m", "intensity"]', app)
        self.assertIn('["dividend", "派息", "港仙", "dots"]', app)
        self.assertIn('["5g_customers", "5G用户", "百万户", "gauge"]', app)
        ...
        self.assertIn(".intelligence-financial-chart.is-intensity", styles)
        self.assertIn(".intelligence-financial-chart.is-dots", styles)
        self.assertIn(".intelligence-financial-chart.is-gauge", styles)
