...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('data-intelligence-drill=', app)
        self.assertIn('data-intelligence-entity=', app)
        self.assertIn('data-intelligence-focus=', app)
        self.assertIn('function entityFocusNote(domain, entity, index, focusId)', app)
        ...
        self.assertIn('const items = entities;', app)
        ...
        self.assertIn('executive-intelligence-bg-v2.webp', styles)
        self.assertIn('Equal-grid technology frame and readable charts v4', styles)
        self.assertIn('Keep strategic-news interaction inside the dark executive theme', styles)
        self.assertIn('background: rgba(16, 49, 65, .78) !important;', styles)
...
class FrontendCitationRenderingTests(unittest.TestCase):
    ...
    def test_voice_dictation_uses_company_stt_and_gives_user_a_send_choice(self) -> None:
        ...
        self.assertIn('id="voiceDeviceSelect"', markup)
        self.assertIn("自动选择（系统默认）", markup)
        ...
        self.assertIn("navigator.mediaDevices.enumerateDevices", app)
        self.assertIn('"devicechange"', app)
        self.assertIn('deviceId: requestedDeviceId ? { exact: requestedDeviceId } : { ideal: "default" }', app)
        self.assertIn("track.getSettings", app)
