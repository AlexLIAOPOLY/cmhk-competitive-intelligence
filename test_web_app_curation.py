...
class ReportFileNameTests(unittest.TestCase):
    ...
    def test_dashboard_uses_four_domain_intelligence_with_drillthrough(self) -> None:
        ...
        self.assertIn('aria-label="市场与竞争数据看板"', html)
        ...
        self.assertIn("去重套餐 ${total} 个 · 数据库记录 ${recordCount} 条", app)
        ...
        self.assertIn('href="/static/styles.css?v=263"', html)
        ...
        self.assertIn('src="/static/app.js?v=267"', html)
