...
class AgenticNewsSearchTests(unittest.TestCase):
    ...
    def test_morning_window_rechecks_previous_afternoon_for_late_indexing(self):
        ...
        self.assertEqual(start_at, datetime(2026, 8, 15, 2, 0, tzinfo=HKT))
    ...
    def test_afternoon_window_keeps_one_hour_overlap_with_morning_slot(self):
        ...
        self.assertEqual(start_at, datetime(2026, 8, 16, 2, 0, tzinfo=HKT))
    ...
    def test_digest_card_is_sent_to_both_report_groups(self):
        responses = [
            ...
            {"data": {"message_id": "om_requirements"}, "_identity": "bot"},
        ]
        with mock.patch.object(
            strategic_briefing,
            "_lark_api",
        ...
        self.assertEqual(message_ids, ["om_primary", "om_requirements"])
        self.assertEqual(
