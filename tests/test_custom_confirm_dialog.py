...
class CustomConfirmDialogTests(unittest.TestCase):
    def test_shared_dialog_assets_are_loaded_before_feature_scripts(self):
        ...
        self.assertLess(index.index('/static/confirm-dialog.js?v=3'), index.index('/static/app.js?v=295'))
        self.assertIn('/static/confirm-dialog.css?v=1', subscription)
        self.assertLess(subscription.index('/static/confirm-dialog.js?v=3'), subscription.index('/static/subscription-admin.js?v=22'))
