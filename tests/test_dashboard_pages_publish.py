...
class DashboardPagesPublishTests(unittest.TestCase):
    ...
    def test_monitoring_dashboard_shows_all_local_operator_metrics_without_tabs(self):
        ...
        self.assertIn('barWidth: diverging ? 10 : (lollipop ? 9 : 12)', script)
        self.assertIn('rich.name = { color: "#a9c0cb", fontSize: 12', script)
        self.assertIn('symbolSize: lollipop ? 16 : (diverging ? 12 : 0)', script)
