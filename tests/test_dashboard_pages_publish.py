...
class DashboardPagesPublishTests(unittest.TestCase):
    ...
    def test_monitoring_dashboard_shows_all_local_operator_metrics_without_tabs(self):
        ...
        self.assertIn("cmhkReferenceSnapshot", script)
        ...
        self.assertIn('label: "主营业务收入", value: "39.95", unit: "亿港元", dimension: "金额｜累计"', script)
        self.assertIn('label: "净利润率", value: "10.2", unit: "%", dimension: "比率｜期内"', script)
        self.assertIn("cmhk-reference-strip", style)
