...
class DashboardPagesPublishTests(unittest.TestCase):
    ...
    def test_monitoring_dashboard_shows_all_local_operator_metrics_without_tabs(self):
        ...
        self.assertIn('chartTypes: ["lollipop", "lollipop", "lollipop", "lollipop", "lollipop", "lollipop"]', script)
        self.assertIn('key: "reach", number: "03", title: "渠道与品牌触达层", metricCount: 2, chartTypes: ["lollipop", "lollipop"]', script)
        self.assertIn('chartTypes: ["lollipop", "lollipop", "diverging"]', script)
