...
class DashboardPagesPublishTests(unittest.TestCase):
    ...
    def test_monitoring_dashboard_shows_all_local_operator_metrics_without_tabs(self):
        ...
        self.assertIn("chart-ring-hit-area", script)
        ...
        self.assertIn("stroke-width: 36; pointer-events: stroke", style)
        self.assertIn(".chart-interactive-mark { cursor: pointer", style)
