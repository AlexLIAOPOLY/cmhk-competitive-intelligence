...
class AuthServiceTest(unittest.TestCase):
    ...
    def test_login_page_exposes_only_feishu_sign_in(self):
        ...
        self.assertIn("@keyframes page-flip", page)
        self.assertIn("@keyframes particle-drift", page)
        self.assertIn("@keyframes core-sheen", page)
        self.assertEqual(page.count('class="motion-particle is-'), 12)
        self.assertIn('class="motion-page is-three"', page)
        self.assertNotIn("@keyframes orbit-spin", page)
        self.assertNotIn('class="motion-orbit', page)
        self.assertIn('<circle cx="32" cy="27"', page)
        self.assertIn('M20 44c2.2-6.7 6.2-10 12-10s9.8 3.3 12 10', page)
        self.assertNotIn("M39 42l4 4 8-10", page)
