...
class LocalHKOperatorOperatingDatabaseTest(unittest.TestCase):
    ...
    def test_public_web_backfills_and_related_scope_evidence_are_retained(self) -> None:
        ...
        self.assertEqual(self.row("hkbn", 2023, "homes_passed_or_connected")["official_value"], "2.56")
        self.assertEqual(self.row("hkbn", 2023, "commercial_buildings_covered")["official_value"], "8090")
        hkbn_2023_arpu = self.row("hkbn", 2023, "residential_arpu")
        self.assertEqual(hkbn_2023_arpu["related_public_value"], "177")
        self.assertIn("2H2023", hkbn_2023_arpu["related_public_note"])
