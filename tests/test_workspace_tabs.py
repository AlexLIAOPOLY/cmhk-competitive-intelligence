...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.css?v=152', INDEX)
        self.assertIn('workspace-tabs.js?v=174', INDEX)
        ...
        self.assertIn('hasCompanyAgentProgress ? "家公司已记录"', SCRIPT)
        ...
        self.assertIn("animation-name: news-lineage-feedback-flow-global,news-lineage-feedback-breathe", STYLE)
        self.assertIn("to { stroke-dashoffset: -132; }", STYLE)
        self.assertIn("@keyframes news-lineage-feedback-breathe", STYLE)
