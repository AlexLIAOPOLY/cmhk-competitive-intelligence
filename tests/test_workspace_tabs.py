...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=126', INDEX)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=126', INDEX)
        self.assertIn('selectedTab.scrollIntoView({ block: "nearest", inline: "center"', SCRIPT)
        self.assertIn('workspace-tabs.css?v=121', INDEX)
        ...
        self.assertIn("当天数据库入库与数据变化", SCRIPT)
        self.assertIn("当天UI重新发布与数据变化", SCRIPT)
        self.assertIn("已发布到UI", SCRIPT)
        self.assertIn("重新发布 ${number(uiItemCount)} 项 · 数据变化 ${number(sourceChanged)} 项", SCRIPT)
        self.assertIn("数据变化按本轮官方来源内容变化统计", SCRIPT)
        ...
        self.assertIn("成功来源中：内容变化", SCRIPT)
