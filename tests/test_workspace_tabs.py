...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=125', INDEX)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=125', INDEX)
        ...
        self.assertIn('domainNode("local", "本地运营商", [770, 440]', SCRIPT)
        self.assertIn('domainNode("international", "国际运营商", [952, 440]', SCRIPT)
        self.assertIn('position: [1260, 473]', SCRIPT)
        self.assertIn('label: "四库UI发布", position: [750, 408]', SCRIPT)
