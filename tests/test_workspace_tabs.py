...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=187', INDEX)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.css?v=161', INDEX)
        self.assertIn('workspace-tabs.js?v=187', INDEX)
        ...
        self.assertIn('agent: [570, 500]', SCRIPT)
        self.assertIn('"database-hub": [820, 530]', SCRIPT)
        self.assertIn('"database-local": [1020, 470]', SCRIPT)
        self.assertIn('"database-international": [1185, 470]', SCRIPT)
        self.assertIn('"database-cloud": [1020, 605]', SCRIPT)
        self.assertIn('"database-mainland": [1185, 605]', SCRIPT)
        self.assertIn('insights: [1415, 535]', SCRIPT)
        self.assertIn('label: "审核通过数据按主体类型写入四库并发布到 UI", note: "四库已发布数据汇总生成右侧 AI 战略洞察", position: [980, 430], size: [389, 315]', SCRIPT)
