...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=132', INDEX)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=132', INDEX)
        self.assertIn('selectedTab.scrollIntoView({ block: "nearest", inline: "center"', SCRIPT)
        self.assertIn('workspace-tabs.css?v=126', INDEX)
        ...
        self.assertIn('["news-output", "news-db-signal", "前一日新闻进入01:00", "previous-day"]', SCRIPT)
        self.assertIn('["news-db-signal", "main", "03:00追官方原文", "amber"]', SCRIPT)
        ...
        self.assertIn('position: [285, 473]', SCRIPT)
        self.assertIn('position: [550, 494]', SCRIPT)
        self.assertIn('domainNode("local", "本地运营商", [770, 425]', SCRIPT)
        self.assertIn('domainNode("international", "国际运营商", [952, 425]', SCRIPT)
        self.assertIn('domainNode("cloud", "全球云厂商", [770, 563]', SCRIPT)
        self.assertIn('domainNode("mainland", "内地运营商", [952, 563]', SCRIPT)
        self.assertIn('position: [1260, 473]', SCRIPT)
        self.assertIn('label: "四库UI发布", position: [750, 393]', SCRIPT)
        ...
        self.assertIn('kind === "previous-day"', SCRIPT)
