...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=184', INDEX)
        ...
        self.assertIn('本节点不产出数据库数据事实', SCRIPT)
        ...
        self.assertIn('label: "审核事实按主体类型写入四库并发布到 UI"', SCRIPT)
        ...
        self.assertIn('label: "审核事实按主体类型写入四库并发布到 UI", note: "四库已发布数据汇总生成右侧 AI 战略洞察", position: [950, 370], size: [389, 301]', SCRIPT)
