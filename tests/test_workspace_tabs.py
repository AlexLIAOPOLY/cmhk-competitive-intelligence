...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_competitor_workbench_starts_empty_and_uses_historical_data(self):
        ...
        self.assertIn("animateCompetitorOptionParticles", SCRIPT)
        self.assertIn('mode: "scatter"', SCRIPT)
        self.assertIn('mode: "assemble"', SCRIPT)
        self.assertIn("competitor-particle-layer", STYLE)
