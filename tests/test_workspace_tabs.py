...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=134', INDEX)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=134', INDEX)
        self.assertIn('selectedTab.scrollIntoView({ block: "nearest", inline: "center"', SCRIPT)
        self.assertIn('workspace-tabs.css?v=128', INDEX)
        ...
        self.assertIn("canvasSize: [1740, 720]", SCRIPT)
        ...
        self.assertIn('label: "C｜固定官方源复核、入库与UI发布线", position: [18, 438]', SCRIPT)
        self.assertNotIn('note: "仅官方原文 + 字段门禁通过才写入"', SCRIPT)
        self.assertIn('position: [590, 473]', SCRIPT)
        self.assertIn('position: [860, 494]', SCRIPT)
        self.assertIn('domainNode("local", "本地运营商", [1060, 425]', SCRIPT)
        self.assertIn('domainNode("international", "国际运营商", [1242, 425]', SCRIPT)
        self.assertIn('domainNode("cloud", "全球云厂商", [1060, 563]', SCRIPT)
        self.assertIn('domainNode("mainland", "内地运营商", [1242, 563]', SCRIPT)
        self.assertIn('position: [1510, 473]', SCRIPT)
        self.assertIn('label: "四库UI发布", position: [1040, 393]', SCRIPT)
