...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/workspace-tabs.js?v=121', INDEX)
    ...
    def test_competitor_workbench_starts_empty_and_uses_historical_data(self):
        ...
        self.assertIn('if (companies.length < 2 || !metric || !years)', SCRIPT)
    ...
    def test_news_module_maps_all_periodic_crawlers_into_four_database_updates(self):
        ...
        self.assertIn('workspace-tabs.js?v=121', INDEX)
        ...
        self.assertIn('unit: intelligenceRun.crawl_run_id ? "条入库信息"', SCRIPT)
        self.assertIn("executiveDomainFactsForDate", SCRIPT)
        self.assertIn("当天入库信息明细", SCRIPT)
        self.assertIn("来源内容变化", SCRIPT)
        ...
        self.assertIn('label: "C｜固定官方源更新线", position: [18, 438]', SCRIPT)
        self.assertNotIn('note: "仅官方原文 + 字段门禁通过才写入"', SCRIPT)
        self.assertIn('label: "四库更新", position: [610, 408]', SCRIPT)
