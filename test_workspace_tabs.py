...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_navigation_is_linkable_responsive_and_keyboard_accessible(self):
        ...
        self.assertIn('/static/workspace-tabs.css?v=79', INDEX)
        self.assertIn('/static/workspace-tabs.js?v=70', INDEX)
        ...
        self.assertIn('/static/subscription-admin.css?v=18', (ROOT / "web" / "static" / "subscription-admin.html").read_text(encoding="utf-8"))
