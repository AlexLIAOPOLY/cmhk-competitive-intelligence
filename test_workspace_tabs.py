...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_auth_permissions_gate_tabs_requests_and_organization_admin(self):
        ...
        self.assertIn('/static/organization-admin.js?v=8', INDEX)
        self.assertIn('/static/organization-admin.css?v=8', INDEX)
    ...
    def test_competitor_workbench_starts_empty_and_uses_historical_data(self):
        ...
        self.assertIn('copy.textContent = String(insight ?? "")', SCRIPT)
        self.assertIn('copy.textContent = String(text)', SCRIPT)
