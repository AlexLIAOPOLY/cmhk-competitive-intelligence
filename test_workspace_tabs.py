...
class WorkspaceTabsTests(unittest.TestCase):
    ...
    def test_navigation_is_linkable_responsive_and_keyboard_accessible(self):
        ...
        self.assertIn('/static/workspace-tabs.css?v=75', INDEX)
        self.assertIn('/static/workspace-tabs.js?v=66', INDEX)
    ...
    def test_competitor_workbench_starts_empty_and_uses_historical_data(self):
        ...
        self.assertIn("/static/assets/ai-insight-sparkle.png", SCRIPT)
        self.assertTrue((ROOT / "web" / "static" / "assets" / "ai-insight-sparkle.png").exists())
